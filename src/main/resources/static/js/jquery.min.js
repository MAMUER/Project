var FullCalendar = function (e) {
    ...
    function ft(e, t) {
        return "string" == typeof e ? function (e) {
            ...
            return null
        }(e) : "object" == typeof e && e ? gt(e) : "number" == typeof e ? gt({ [t || "milliseconds"]: e }) : null
    }
    ...
    function It(e, t, n, r) {
        let i = Bt([t, 0, 1 + Ot(t, n, r)]), s = Mt(e), o = Math.round(xt(i, s));
    ...
    const qt = { week: 3, separator: 0, omitZeroMinute: 0, meridiem: 0, omitCommas: 0 },
        ...
        Zt = /\s*([ap])\.?m\.?/i, Xt = /,/g, $t = /\s+/g, Jt = /\u200e/g, Kt = /UTC|GMT/;
    ...
    class Hn {
        ...
        greatestWholeUnit(e, t) {
            ...
            return null !== n ? { unit: "year", value: n } : (n = this.diffWholeMonths(e, t), null !== n ? {
                unit: "month",
                value: n
            } : (n = Tt(e, t), null !== n ? { unit: "week", value: n } : (n = kt(e, t), null !== n ? {
                unit: "day",
                value: n
            } : (n = function (e, t) {
                return (t.valueOf() - e.valueOf()) / 36e5
            }(e, t), ct(n) ? { unit: "hour", value: n } : (n = function (e, t) {
                return (t.valueOf() - e.valueOf()) / 6e4
            }(e, t), ct(n) ? { unit: "minute", value: n } : (n = function (e, t) {
                return (t.valueOf() - e.valueOf()) / 1e3
            }(e, t), ct(n) ? { unit: "second", value: n } : { unit: "millisecond", value: t.valueOf() - e.valueOf() }))))))
        }
        ...
        computeWeekNumber(e) {
            return this.weekNumberFunc ? this.weekNumberFunc(this.toDate(e)) : function (e, t, n) {
                let r = e.getUTCFullYear(), i = It(e, r, t, n);
    ...
    function jn(e) {
        ...
        for (n.debounceRendering = function (e) {
            r.push(e)
        }, U(p(zn, {}), document.createElement("div")); r.length;) r.shift()();
    ...
    class qn extends Gn {
        constructor() {
            super(...arguments), this.id = Ze(), this.queuedDomNodes = [], this.currentDomNodes = [], this.handleEl = e => {
                Yn(this.props.generatorName, this.context.options) || this.updateElRef(e)
            }, this.updateElRef = e => {
        ...
        triggerCustomRendering(e) {
            ...
            if (i) {
                ...
                r && i(Object.assign(Object.assign({
                    ...
                    generatorMeta: r
                }, n), { elClasses: (n.elClasses || []).filter(Xn) }))
            }
        }
    ...
    qn.addPropsEquality({
        elClasses: St, elStyle: Cn, elAttrs: function (e, t) {
            const n = xn(e, t);
    ...
    class Jn extends D {
        constructor() {
            super(...arguments), this.InnerContent = Kn.bind(void 0, this), this.handleEl = e => {
                this.el = e, this.props.elRef && Qn(this.props.elRef, e)
            }
        }
        ...
        render() {
            ...
            if (e.children) {
                const n = Zn(e, t, this.handleEl), r = e.children(this.InnerContent, e.renderProps, n);
    ...
    function nr(e, t) {
        let n, r, i = [], { start: s } = t;
        for (e.sort(rr), n = 0; n < e.length; n += 1) r = e[n], r.start > s && i.push({
            start: s,
            end: r.start
        }), r.end > s && (s = r.end);
    ...
    function cr(e) {
        let t = Math.floor(xt(e.start, e.end)) || 1, n = Mt(e.start);
    ...
    function Sr(e, t, n, r, i = Dr(n), s, o) {
        let { refined: a, extra: l } = Ar(e, n, i), c = function (e, t) {
            let n = null;
            e && (n = e.defaultAllDay);
    ...
    function kr(e, t) {
        let n = Sn(e.defs, t), r = Sn(e.instances, e => n[e.defId]);
    ...
    function jr(e, t, n = zr(t)) {
        ...
        if ("string" == typeof e ? r = { url: e } : "function" == typeof e || Array.isArray(e) ? r = { events: e } : "object" == typeof e && e && (r = e), r) {
            let { refined: i, extra: s } = vn(r, n), o = function (e, t) {
    ...
    function Fr(e, t, n) {
        let { defs: r } = e, i = An(e.instances, e => r[e.defId].allDay ? e : Object.assign(Object.assign({}, e), {
            range: {
    ...
    function $r(e, t, n, r) {
        let i = li(e.defs, t), s = { defs: {}, instances: {} };
        for (let t in e.defs) {
            let o = e.defs[t];
    ...
    class ti {
        ...
        setProp(e, t) {
            if (e in br) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead."); else if ("id" === e) t = yr[e](t), this.mutate({ standardProps: { publicId: t } }); else if (e in yr) t = yr[e](t), this.mutate({ standardProps: { [e]: t } }); else if (e in Ir) {
                let n = Ir[e](t);
        ...
        formatRange(e) {
            let { dateEnv: t } = this._context, n = this._instance, r = an(e);
        ...
        mutate(e) {
            ...
            if (t) {
                let n = this._def, r = this._context, { eventStore: i } = r.getCurrentData(), s = xr(i, t.instanceId);
                s = $r(s, {
                    "": {
                        display: "",
                        startEditable: !0,
                ...
                this._def = s.defs[n.defId], this._instance = s.instances[t.instanceId], r.dispatch({
                    ...
                    oldEvent: o, event: this, relatedEvents: ri(s, r, t), revert() {
    ...
    function ii(e, t, n, r) {
        let i = {}, s = {}, o = {}, a = [], l = [], c = li(e.defs, t);
        for (let t in e.defs) {
            let n = e.defs[t];
            "inverse-background" === c[n.defId].display && (n.groupId ? (i[n.groupId] = [], o[n.groupId] || (o[n.groupId] = n)) : s[t] = [])
        }
        for (let t in e.instances) {
            let o = e.instances[t], d = e.defs[o.defId], u = c[d.defId], h = o.range, f = !d.allDay && r ? dr(h, r) : h,
                g = ir(f, n);
    ...
    function pi(e, t, n, r, i, s, o) {
        ...
        let f = h.range.start, g = h.range.end, p = s || e.start || e.eventRange.range.start,
            m = o || e.end || e.eventRange.range.end, v = Mt(f).valueOf() === Mt(p).valueOf(),
    ...
    function Si(e, t, n) {
        let r = function (e, t) {
            let { refined: n, extra: r } = vn(e, Ei), i = n.start ? t.createMarkerMeta(n.start) : null,
    ...
    class Ni {
        ...
        incrementDate(e) {
            let t = this.getCurrentData(), n = ft(e);
        ...
        select(e, t) {
            ...
            let r = this.getCurrentData(), i = Si(n, r.dateEnv, ft({ days: 1 }));
        ...
        addEvent(e, t) {
            if (e instanceof ti) {
                ...
                return this.getCurrentData().eventStore.defs[t.defId] || (this.dispatch({
                    type: "ADD_EVENTS",
                    eventStore: Rr({ def: t, instance: n })
                }), this.triggerEventAdd(e)), e
            }
            let n, r = this.getCurrentData();
            if (t instanceof ei) n = t.internalEventSource; else if ("boolean" == typeof t) t && ([n] = wn(r.eventSources)); else if (null != t) {
    ...
    class Wi {
        ...
        splitProps(e) {
            ...
            for (let n in t) {
                let c = t[n], d = s[n] || Ui, u = this.eventUiBuilders[n];
                l[n] = {
    ...
    const Gi = an({ year: "numeric", month: "long", day: "numeric" }), Qi = an({ week: "long" });
    ...
    function Ki(e, t = !1) {
        let n = window.getComputedStyle(e), r = parseInt(n.borderLeftWidth, 10) || 0,
            ...
            o = parseInt(n.borderBottomWidth, 10) || 0, a = Ji(e), l = a.y - r - i, c = {
                borderLeft: r,
                borderRight: i,
                borderTop: s,
                borderBottom: o,
    ...
    function es(e, t = !1, n) {
        let r = n ? e.getBoundingClientRect() : ts(e), i = Ki(e, t), s = {
    ...
    class cs {
        ...
        splitEntry(e, t, n) {
            ...
            }, i)), r ? (n.push({ index: e.index, thickness: e.thickness, span: fs(o, s) }, ...i), r) : (n.push(e), 0)
        }
        ...
        findInsertion(e) {
            ...
            for (let u = 0; u < s; u += 1) {
                ...
                let h, f = n[u], g = ps(f, e.span.start, ds), p = g[0] + g[1];
    ...
    function hs(e) {
        ...
        for (let i of e) {
            ...
            for (let i of t) fs(i.span, s.span) ? s = {
    ...
    const vs = {}, ys = { startTime: ft, duration: ft, create: Boolean, sourceId: String };
    ...
    function Es(e, t) {
        return an(!e || t > 10 ? { weekday: "short" } : t > 1 ? {
            weekday: "short",
            month: "numeric",
            day: "numeric",
            omitCommas: !0
    ...
    class Ds extends Gn {
        render() {
            let { dateEnv: e, options: t, theme: n, viewApi: r } = this.context, { props: i } = this, {
                date: s,
                dateProfile: o
            } = i, a = Fi(s, i.todayRange, null, o), l = [Ss].concat(Vi(a, n)), c = e.format(s, i.dayHeaderFormat),
    ...
    class Cs extends Gn {
        render() {
            ...
            return p(Jn, {
                ...
                elAttrs: { "aria-label": t.format(s, ws) }
            })))
        }
    }
    ...
    class Rs extends D {
        ...
        computeTiming() {
            let { props: e, context: t } = this,
                ...
                r = t.dateEnv.startOf(n, e.unit), i = t.dateEnv.add(r, ft(1, e.unit)), s = i.valueOf() - n.valueOf();
            return s = Math.min(864e5, s), {
                currentState: { nowDate: r, todayRange: xs(r) },
                nextState: { nowDate: i, todayRange: xs(i) },
                waitMs: s
            }
        }
    ...
    class _s extends Gn {
        ...
        render() {
            ...
            return p(Rs, { unit: "day" }, (e, o) => p("tr", { role: "row" }, i && i("day"), t.map(e => r ? p(Ds, {
                key: e.toISOString(),
                date: e,
                dateProfile: n,
                todayRange: o,
                colCnt: t.length,
                dayHeaderFormat: s
            }) : p(Cs, { key: e.getUTCDay(), dow: e.getUTCDay(), dayHeaderFormat: s }))))
        }
    }
    ...
    class ks {
        constructor(e, t) {
            ...
            for (; n < r;) t.isHiddenDay(n) ? i.push(o + .5) : (o += 1, i.push(o), s.push(n)), n = wt(n, 1);
            this.dates = s, this.indices = i, this.cnt = s.length
        }

        sliceRange(e) {
            let t = this.getDateDayIndex(e.start), n = this.getDateDayIndex(wt(e.end, -1)), r = Math.max(0, t),
        ...
        getDateDayIndex(e) {
            let { indices: t } = this, n = Math.floor(xt(this.dates[0], e));
    ...
    class Is {
        ...
        _sliceDateSpan(e, t, n, r, i, ...s) {
            if (!e) return [];
            let o = Os(t, Boolean(n)), a = ir(e.range, o);
            if (a) {
                let t = function (e, t, n) {
                    let r = Ar({ editable: !1 }, n), i = wr(r.refined, r.extra, "", e.allDay, !0, n);
                    return {
                        def: i,
                        ui: ci(i, t),
    ...
    function Bs(e, t, n = {}, r) {
        return !(e.eventDrag && !function (e, t, n, r) {
            ...
            }), u = d.defs, h = d.instances, f = li(u, e.eventUiBases);
            var g, p;
            for (let r in l) {
    ...
    function Gs(e) {
        let t = Pe(e, ".fc-scrollgrid-shrink"), n = 0;
    ...
    function Xs(e, t) {
        ...
        for (let r of e) {
            ...
            for (let i = 0; i < e; i += 1) n.push(p("col", {
                style: {
                    width: "shrink" === r.width ? $s(t) : r.width || "",
                    minWidth: r.minWidth || ""
                }
            }))
        }
    ...
    class io extends Gn {
        constructor() {
            super(...arguments), this.processCols = Gt(e => e, Zs), this.renderMicroColGroup = Gt(Xs), this.scrollerRefs = new Vs, this.scrollerElRefs = new Vs(this._handleScrollerEl.bind(this)), this.state = {
                shrinkWidth: null,
                forceYScrollbars: !1,
        ...
        render() {
            let { props: e, state: t, context: n } = this, r = e.sections || [], i = this.processCols(e.cols),
                s = this.renderMicroColGroup(i, t.shrinkWidth), o = Ks(e.liquid, n);
        ...
        renderChunkTd(e, t, n, r) {
            ...
            } = this.state, l = qs(i, e), c = Qs(i, e), d = i.liquid ? s ? "scroll" : l ? "auto" : "hidden" : "visible",
                u = e.key, h = Ys(e, n, {
                    tableColGroupNode: t,
                    tableMinWidth: "",
            ...
            return p(r ? "th" : "td", {
                ref: n.elRef,
                role: "presentation"
            }, p("div", { className: "fc-scroller-harness" + (c ? " fc-scroller-harness-liquid" : "") }, p(Fs, {
        ...
        computeScrollerDims() {
            let e = $i(), { scrollerRefs: t, scrollerElRefs: n } = this, r = !1, i = {}, s = {};
    ...
    const lo = e => p(Ln.Consumer, null, t => {
    ...
    function fo(e) {
        let { date: t, dateEnv: n, dateProfile: r, isMonthStart: i } = e, s = Fi(t, e.todayRange, null, r),
    ...
    const vo = e => p(Ln.Consumer, null, t => {
    ...
    class bo extends Gn {
        constructor() {
            super(...arguments), this.state = { titleId: We() }, this.handleRootEl = e => {
        ...
        updateSize() {
            let { isRtl: e } = this.context, { alignmentEl: t, alignGridTop: n } = this.props, { rootEl: r } = this,
                i = function (e) {
                    let t = ns(e), n = e.getBoundingClientRect();
                    for (let e of t) {
            ...
            if (i) {
                let s = r.getBoundingClientRect(), o = n ? Oe(t, ".fc-scrollgrid").getBoundingClientRect().top : i.top,
    ...
    class Eo extends ls {
        ...
        render() {
            ...
            return p(uo, {
                ...
                onClose: n.onClose
            }, ho(e) && p(t, { elTag: "div", elClasses: ["fc-more-popover-misc"] }), n.children))
        }
    ...
    class So extends Gn {
        constructor() {
            super(...arguments), this.state = { isPopoverOpen: !1, popoverId: We() }, this.handleLinkEl = e => {
                this.linkEl = e, this.props.elRef && Qn(this.props.elRef, e)
            }, this.handleClick = e => {
                let { props: t, context: n } = this, { moreLinkClick: r } = n.options, i = Do(t).start;
        ...
        render() {
            ...
            return p(Ln.Consumer, null, n => {
                let { viewApi: r, options: i, calendarApi: s } = n, { moreLinkText: o } = i, { moreCnt: a } = e, l = Do(e),
                    c = "function" == typeof o ? o.call(s, a) : `+${a} ${o}`, d = at(i.moreLinkHint, [a], c),
    ...
    var xo = {
        ...
        memoizeHashlike: function (e, t, n) {
            ...
            return s => {
                let o = {};
                for (let a in s) if (i[a]) if (St(r[a], s[a])) o[a] = i[a]; else {
                    n && n(i[a]);
    ...
    const To = [], ko = {
        ...
        allDayText: "all-day",
        moreLinkText: "more",
        noEventsText: "Нет запланированных событий"
    ...
    function Wo(e) {
        ...
        return t.content ? n = Lo(t) : !n || n.prototype instanceof Gn || (n = Lo(Object.assign(Object.assign({}, t), { content: n }))), {
            superType: t.type,
            component: n,
            rawOptions: t
        }
    ...
    function Lo(e) {
        return t => p(Ln.Consumer, null, n => p(Jn, {
            elTag: "div",
    ...
    function Go(e, t, n) {
        ...
        return Yo({}, function (e, t) {
            let n = zr(t), r = [].concat(e.eventSources || []), i = [];
    ...
    function Zo(e, t, n) {
        return Xo(e, Sn(e, e => function (e, t, n) {
    ...
    function $o(e, t, n, r) {
        let { options: i, calendarApi: s } = r, o = r.pluginHooks.eventSourceDefs[e.sourceDefId], a = Ze();
        ...
        name: "simple-recurring-event", recurringTypes: [{
            parse(e, t) {
                ...
                return r ? function (e, t, n, r) {
                    let i = e ? Dn(e) : null, s = Mt(n.start), o = n.end, a = [];
                    for (; s < o;) {
                        let e;
    ...
    class ha {
        ...
        _handleAction(e) {
            ...
            let u = Qo(n.eventSources, e, d, l), h = Ur(n.eventStore, e, u, d, l),
        ...
        processRawCalendarOptions(e, t) {
            let { locales: n, locale: r } = mn([cn, e, t]), i = this.organizeRawLocales(n), s = i.map,
                ...
                c = {}, d = mn([cn, o, e, t]), u = {}, h = this.currentCalendarOptionsInput,
        ...
        processRawViewOptions(e, t, n, r, i) {
            ...
            for (let e in s) s[e] === l[e] || hn[e] && hn[e](s[e], l[e]) ? a[e] = c[e] : (s[e] === this.currentCalendarOptionsInput[e] || hn[e] && hn[e](s[e], this.currentCalendarOptionsInput[e]) ? e in this.currentCalendarOptionsRefined && (a[e] = this.currentCalendarOptionsRefined[e]) : o[e] ? a[e] = o[e](s[e]) : u[e] = s[e], d = !0);
    ...
    class Ra extends Mi {
        constructor(e) {
            super(e), this.handleSegClick = (e, t) => {
                let { component: n } = this, { context: r } = n, i = ai(t);
                if (i && n.isValidSegDownEl(e.target)) {
                    let s = Oe(e.target, ".fc-event-forced-url"), o = s ? s.querySelector("a[href]").href : "";
    ...
    class xa extends Mi {
        ...
        triggerEvent(e, t, n) {
            let { component: r } = this, { context: i } = r, s = ai(n);
    ...
    class _a extends Vn {
        constructor() {
            super(...arguments), this.buildViewContext = Gt(Fn), this.buildViewPropTransformers = Gt(ka), this.buildToolbarProps = Gt(Ta), this.headerRef = { current: null }, this.footerRef = { current: null }, this.interactionsStore = {}, this.state = { viewLabelId: We() }, this.registerInteractiveComponent = (e, t) => {
                let n = function (e, t) {
                    return {
                        component: e,
                        el: t.el,
        ...
        render() {
            ...
            return p(Ln.Provider, { value: a }, n.header && p(wa, Object.assign({
                ref: this.headerRef,
    ...
    class Pa {
        constructor(e) {
            ...
            }, this.containerEl = e, this.emitter = new Gr, e.addEventListener("mousedown", this.handleMouseDown), e.addEventListener("touchstart", this.handleTouchStart, { passive: !0 }), Oa += 1, 1 === Oa && window.addEventListener("touchmove", Ha, { passive: !1 })
        }
    ...
    class Ba {
        ...
        doRevertAnimation(e, t) {
            ...
            n.style.transition = "top " + t + "ms,left " + t + "ms", Be(n, { left: r.left, top: r.top }), Ge(n, () => {
    ...
    class Fa extends ms {
        constructor(e, t) {
            super(e), this.containerEl = e, this.delay = null, this.minDistance = 0, this.touchScrollAllowed = !0, this.mirrorNeedsRevert = !1, this.isInteracting = !1, this.isDragging = !1, this.isDelayEnded = !1, this.isDistanceSurpassed = !1, this.delayTimeoutId = null, this.onPointerDown = e => {
                this.isDragging || (this.isInteracting = !0, this.isDelayEnded = !1, this.isDistanceSurpassed = !1, Je(document.body), et(document.body), e.isTouch || e.origEvent.preventDefault(), this.emitter.trigger("pointerdown", e), this.isInteracting && !this.pointer.shouldIgnoreMove && (this.mirror.setIsVisible(!1), this.mirror.start(e.subjectEl, e.pageX, e.pageY), this.startDelay(e), this.minDistance || this.handleDistanceSurpassed(e)))
                ...
                this.isInteracting && (this.isInteracting = !1, Ke(document.body), tt(document.body), this.emitter.trigger("pointerup", e), this.isDragging && (this.autoScroller.stop(), this.tryStopDrag(e)), this.delayTimeoutId && (clearTimeout(this.delayTimeoutId), this.delayTimeoutId = null))
            };
    ...
    class Va {
        constructor(e) {
            this.origRect = ts(e), this.scrollCaches = ns(e).map(e => new za(e, !0))
        }
            ...
            for (let s in n) {
                ...
                if (a && a.isWithinClipping(e, t)) {
                    ...
                    if (l >= 0 && l < u && c >= 0 && c < h) {
                        ...
                        e && ar(e.dateProfile.activeRange, e.dateSpan.range) && (!i || e.layer > i.layer) && (e.componentId = s, e.context = o.context, e.rect.left += n, e.rect.right += n, e.rect.top += r, e.rect.bottom += r, i = e)
                    }
                }
            }
            return i
    ...
    class Za extends Mi {
        constructor(e) {
            super(e), this.subjectEl = null, this.subjectSeg = null, this.isDragging = !1, this.eventRange = null, this.relevantEvents = null, this.receivingContext = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = e => {
                ...
                let a = this.subjectSeg = ai(e.subjectEl), l = (this.eventRange = a.eventRange).instance.instanceId;
                this.relevantEvents = xr(o.getCurrentData().eventStore, l), r.minDistance = e.isTouch ? 0 : s.eventDragMinDistance, r.delay = e.isTouch && l !== n.props.eventSelection ? function (e) {
                ...
                if (e) {
                    ...
                    i === s || t.editable && t.droppable ? (o = function (e, t, n) {
                        ...
                        let l = hr(s, o, e.context.dateEnv, e.componentId === t.componentId ? e.largeUnit : null);
                ...
                this.displayDrag(s, c), l ? Xe() : $e(), t || (i === s && qa(r, e) && (o = null), this.dragging.setMirrorNeedsRevert(!o), this.dragging.setMirrorIsVisible(!e || !this.subjectEl.getRootNode().querySelector(".fc-event-mirror")), this.receivingContext = s, this.validMutation = o, this.mutatedRelevantEvents = a)
            }, this.handlePointerUp = () => {
                this.isDragging || this.cleanup()
            }, this.handleDragEnd = e => {
                if (this.isDragging) {
                    let t = this.component.context, n = t.viewApi, { receivingContext: r, validMutation: i } = this,
                        s = this.eventRange.def, o = this.eventRange.instance, a = new ti(t, s, o),
                    ...
                    if (this.clearDrag(), t.emitter.trigger("eventDragStop", {
                        ...
                        if (r === t) {
                            ...
                            let d = {
                                oldEvent: a, event: r, relatedEvents: ri(c, t, o), revert() {
                            ...
                            let i = {
                                event: a, relatedEvents: ri(l, t, o), revert() {
                                    t.dispatch({ type: "MERGE_EVENTS", eventStore: l })
                                }
                            };
                            ...
                            let u = c.defs[s.defId], h = c.instances[o.instanceId], f = new ti(r, u, h);
                            r.dispatch({ type: "MERGE_EVENTS", eventStore: c });
                            let g = {
                                event: f, relatedEvents: ri(c, r, h), revert() {
    ...
    const Xa = { fixedMirrorParent: yn }, $a = {
        dateClick: yn,
        eventDragStart: yn,
        eventDragStop: yn,
        eventDrop: yn,
    ...
    class Ja {
        constructor(e, t) {
            this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = e => {
                ...
                }(e.dateSpan, this.dragMeta, i), a.mutatedEvents = Rr(s), o = !Ns(a, e.dateProfile, i), o && (a.mutatedEvents = {
                    defs: {},
                    instances: {}
                }, s = null))), this.displayDrag(i, a), r.setMirrorIsVisible(t || !s || !document.querySelector(".fc-event-mirror")), o ? Xe() : $e(), t || (r.setMirrorNeedsRevert(!s), this.receivingContext = i, this.droppableEvent = s)
            }, this.handleDragEnd = e => {
        ...
        buildDragMeta(e) {
            return "object" == typeof this.suppliedDragMeta ? bs(this.suppliedDragMeta) : "function" == typeof this.suppliedDragMeta ? bs(this.suppliedDragMeta(e)) : function (e) {
                let t = function (e, t) {
                    let n = vs.dataAttrPrefix, r = (n ? n + "-" : "") + t;
    ...
    var el = Po({
        name: "@fullcalendar/interaction", componentInteractions: [class extends Mi {
            constructor(e) {
            ...
            constructor(e) {
                super(e), this.dragSelection = null, this.handlePointerDown = e => {
                    ...
                    if (e) {
                        ...
                        }(t, e, n.pluginHooks.dateSelectionTransformers)), r && Ps(r, e.dateProfile, n) || (i = !0, r = null)
                    }
                    r ? n.dispatch({
                        type: "SELECT_DATES",
                        selection: r
                    }) : t || n.dispatch({ type: "UNSELECT_DATES" }), i ? Xe() : $e(), t || (this.dragSelection = r)
                }, this.handlePointerUp = e => {
            ...
            constructor(e) {
                super(e), this.draggingSegEl = null, this.draggingSeg = null, this.eventRange = null, this.relevantEvents = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = e => {
                    let { component: t } = this, n = ai(this.querySegEl(e)), r = this.eventRange = n.eventRange;
                    ...
                    this.draggingSegEl = r, this.draggingSeg = ai(r), t.calendarApi.unselect(), t.emitter.trigger("eventResizeStart", {
                        el: r,
                        event: new ti(t, n.def, n.instance),
                        jsEvent: e.origEvent,
                        view: t.viewApi
                    ...
                    a && (l = $r(i, r.getCurrentData().eventUiBases, a, r), d.mutatedEvents = l, Ns(d, e.dateProfile, r) || (c = !0, a = null, l = null, d.mutatedEvents = null)), l ? r.dispatch({
                        ...
                        state: d
                    }) : r.dispatch({ type: "UNSET_EVENT_RESIZE" }), c ? Xe() : $e(), t || (a && qa(s, e) && (a = null), this.validMutation = a, this.mutatedRelevantEvents = l)
                }, this.handleDragEnd = e => {
                    ...
                    if (t.emitter.trigger("eventResizeStop", {
                        ...
                        let l = {
                            oldEvent: i, event: a, relatedEvents: ri(o, t, r), revert() {
            ...
            constructor(e) {
                this.context = e, this.isRecentPointerDateSelect = !1, this.matchesCancel = !1, this.matchesEvent = !1, this.onSelect = e => {
                    ...
                    let t = this.context.options.unselectCancel, n = ze(e.origEvent);
    ...
    const il = an({ hour: "numeric", minute: "2-digit", omitZeroMinute: !0, meridiem: "narrow" });
    ...
    class al extends Gn {
        render() {
            let { props: e, context: t } = this, { options: n } = t, { seg: r } = e,
                i = pi(r, n.eventTimeFormat || il, t, !0, e.defaultDisplayEventEnd);
            return p(so, Object.assign({}, e, {
                elTag: "a",
    ...
    class cl extends Gn {
        constructor() {
            super(...arguments), this.compileSegs = Gt(dl)
        }
            ...
            return p(So, {
                ...
                popoverContent: () => {
                    ...
                    return p(y, null, t.map(t => {
                        ...
                        }, mi(t, e.todayRange))) : p(ol, Object.assign({
                            seg: t,
                            isDragging: !1,
                            isResizing: !1,
                            isDateSelecting: !1,
    ...
    const ul = an({ week: "narrow" });

    class hl extends ls {
        constructor() {
            super(...arguments), this.rootElRef = { current: null }, this.state = { dayNumberId: We() }, this.handleRootEl = e => {
        ...
        render() {
            ...
            const l = t.showDayNumber && function (e, t, n) {
                const { start: r, end: i } = t, s = Ct(i, -1), o = n.getYear(r), a = n.getMonth(r), l = n.getYear(s),
                    c = n.getMonth(s);
            ...
            return p(uo, {
                ...
                date: o,
                defaultFormat: ul
            }), !a.isDisabled && (t.showDayNumber || ho(i) || t.forceDayTop) ? p("div", { className: "fc-daygrid-day-top" }, p(s, {
                elTag: "a",
                elClasses: ["fc-daygrid-day-number", l && "fc-daygrid-month-start"],
                elAttrs: Object.assign(Object.assign({}, qi(e, o)), { id: n.dayNumberId })
    ...
    function pl(e) {
        return gl(e) + ":" + e.lastCol
    }

    function ml(e, t, n, r, i, s, o) {
        let a = new yl(t => {
            ...
            for (let e = 0; e < n.length; e += 1) {
                ...
                for (let r of a) {
                    ...
                    d += r.levelCoord - c, c = r.levelCoord + r.thickness, s ? (d += r.thickness, o && u.push({
                        seg: vl(i, r.span.start, r.span.end, n),
                        isVisible: !0,
                        isAbsolute: !0,
                        absoluteTop: r.levelCoord,
                        marginTop: 0
    ...
    function vl(e, t, n, r) {
        ...
        let i = e.eventRange, s = i.range, o = ir(s, { start: r[t].date, end: wt(r[n - 1].date, 1) });
    ...
    class yl extends cs {
        ...
        addSegs(e) {
            const t = super.addSegs(e), { entriesByLevel: n } = this, r = e => !this.forceHidden[us(e)];
        ...
        handleInvalidInsertion(e, t, n) {
            ...
            if (this.hiddenConsumes && s) {
                ...
                if (!i[e]) if (this.allowReslicing) {
                    ...
                    i[us(e)] = !0, r[o][a] = e, this.splitEntry(s, t, n)
                } else i[e] = !0, n.push(s)
            }
    ...
    class bl extends ls {
        constructor() {
            super(...arguments), this.cellElRefs = new Vs, this.frameElRefs = new Vs, this.fgElRefs = new Vs, this.segHarnessRefs = new Vs, this.rootElRef = { current: null }, this.state = {
                framePositions: null,
        ...
        render() {
            let { props: e, state: t, context: n } = this, { options: r } = n, i = e.cells.length,
                ...
                l = nl(this.getMirrorSegs(), i), {
                    ...
                    moreCnts: u,
                    moreMarginTops: h
                } = ml(di(e.fgEventSegs, r.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, r.eventOrderStrict, t.segHeights, t.maxContentHeight, e.cells),
        ...
        renderFgSegs(e, t, n, r, i, s, o) {
            ...
            if (c) for (let e of t) {
                let { seg: t } = e, { instanceId: f } = t.eventRange.instance, g = e.isVisible && !r[f], m = e.isAbsolute,
                    v = "", y = "";
                m && (a.isRtl ? (y = 0, v = c.lefts[t.lastCol] - c.lefts[t.firstCol]) : (v = 0, y = c.rights[t.firstCol] - c.rights[t.lastCol])), h.push(p("div", {
                    className: "fc-daygrid-event-harness" + (m ? " fc-daygrid-event-harness-abs" : ""),
                    key: gl(t),
                    ref: u ? null : this.segHarnessRefs.createRef(pl(t)),
                    style: {
                        visibility: g ? "" : "hidden",
        ...
        renderFillSegs(e, t) {
            ...
            if (i) for (let o of e) {
                ...
                s.push(p("div", {
                    ...
                    style: e
                }, "bg-event" === t ? p(go, Object.assign({ seg: o }, mi(o, r))) : mo(t)))
            }
            return p(y, {}, ...s)
        }
        ...
        updateSizing(e) {
            ...
            if (!t.forPrint && null !== t.clientWidth) {
                if (e) {
                    ...
                    if (e.length) {
                        let t = this.rootElRef.current, r = new rs(t, e, !0, !1);
                        n.framePositions && n.framePositions.similarTo(r) || this.setState({ framePositions: new rs(t, e, !0, !1) })
                    }
                }
                const i = this.state.segHeights, s = this.querySegHeights(),
    ...
    bl.addStateEquality({ segHeights: Cn });

    class El extends ls {
        constructor() {
            super(...arguments), this.splitBusinessHourSegs = Gt(tl), this.splitBgEventSegs = Gt(tl), this.splitFgEventSegs = Gt(tl), this.splitDateSelectionSegs = Gt(tl), this.splitEventDrag = Gt(rl), this.splitEventResize = Gt(rl), this.rowRefs = new Vs
        }
        ...
        render() {
            ...
            return p(Rs, { unit: "day" }, (t, d) => p(y, null, e.cells.map((t, u) => p(bl, {
        ...
        prepareHits() {
            this.rowPositions = new rs(this.rootEl, this.rowRefs.collect().map(e => e.getCellEls()[0]), !1, !0), this.colPositions = new rs(this.rootEl, this.rowRefs.currentMap[0].getCellEls(), !0, !1)
        }
    ...
    class Al extends ls {
        ...
        render() {
            ...
            }, e.colGroupNode, p("tbody", { role: "presentation" }, p(El, {
                dateProfile: e.dateProfile,
                cells: e.cells,
    ...
    class wl extends ls {
        constructor() {
            super(...arguments), this.slicer = new Dl, this.tableRef = { current: null }
        }

        render() {
            let { props: e, context: t } = this;
            return p(Al, Object.assign({ ref: this.tableRef }, this.slicer.sliceProps(e, e.dateProfile, e.nextDayThreshold, t, e.dayTableModel), {
                dateProfile: e.dateProfile,
    ...
    class xl extends ls {
        ...
        renderSimpleLayout(e, t) {
            let { props: n, context: r } = this, i = [], s = no(r.options);
            return e && i.push({
                type: "header",
                key: "header",
                isSticky: s,
                chunk: { elRef: this.headerElRef, tableClassName: "fc-col-header", rowContent: e }
            }), i.push({ type: "body", key: "body", liquid: !0, chunk: { content: t } }), p(er, {
                elClasses: ["fc-daygrid"],
                viewSpec: r.viewSpec
            }, p(io, { liquid: !n.isHeightAuto && !n.forPrint, collapsibleWidth: n.forPrint, cols: [], sections: i }))
        }
        ...
        renderHScrollLayout(e, t, n, r) {
            ...
            let { props: s, context: o } = this, a = !s.forPrint && no(o.options), l = !s.forPrint && ro(o.options),
                c = [];
            return e && c.push({
                type: "header",
                key: "header",
                ...
                key: "footer",
                isSticky: !0,
                chunks: [{ key: "main", content: to }]
            }), p(er, { elClasses: ["fc-daygrid"], viewSpec: o.viewSpec }, p(i, {
        ...
        name: "@fullcalendar/daygrid", initialView: "dayGridMonth", views: {
            dayGrid: {
                component: class extends xl {
                    constructor() {
                        super(...arguments), this.buildDayTableModel = Gt(_l), this.headerRef = { current: null }, this.tableRef = { current: null }
                    }

                    render() {
                        let { options: e, dateProfileGenerator: t } = this.context, { props: n } = this,
                            r = this.buildDayTableModel(n.dateProfile, t), i = e.dayHeaders && p(_s, {
                                ref: this.headerRef,
    ...
    class Hl extends ls {
        constructor() {
            super(...arguments), this.allDaySplitter = new kl, this.headerElRef = { current: null }, this.rootElRef = { current: null }, this.scrollerElRef = { current: null }, this.state = { slatCoords: null }, this.handleScrollTopRequest = e => {
        ...
        renderSimpleLayout(e, t, n) {
            let { context: r, props: i } = this, s = [], o = no(r.options);
            return e && s.push({
                type: "header",
                key: "header",
                isSticky: o,
        ...
        renderHScrollLayout(e, t, n, r, i, s, o) {
            ...
            let { context: l, props: c } = this, d = !c.forPrint && no(l.options), u = !c.forPrint && ro(l.options),
                h = [];
            e && h.push({
                type: "header",
                key: "header",
            ...
            return h.push({
                ...
                chunks: [{
                    ...
                    }, e.tableColGroupNode, p("tbody", null, p(Nl, { slatMetas: s }))), p("div", { className: "fc-timegrid-now-indicator-container" }, p(Rs, { unit: f ? "minute" : "day" }, e => {
                ...
                type: "footer",
                isSticky: !0,
                chunks: [{ key: "axis", content: to }, { key: "cols", content: to }]
            }), p(er, {
                elRef: this.rootElRef,
                elClasses: ["fc-timegrid"],
                viewSpec: l.viewSpec
    ...
    class jl {
        ...
        safeComputeTop(e) {
            ...
            if (lr(t.currentRange, e)) {
                let n = Mt(e), r = e.valueOf() - n.valueOf();
    ...
    class Ul extends Gn {
        ...
        render() {
            ...
            }, e.tableColGroupNode, p(zl, { slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas })))
        }
    ...
    function Gl(e, t, n) {
        ...
        let i = hs(r.addSegs(e)), s = function (e) {
            const { entriesByLevel: t } = e, n = Zl((e, t) => e + ":" + t, (r, i) => {
                let s = Ql(function (e, t, n) {
                    let { levelCoords: r, entriesByLevel: i } = e, s = i[t][n], o = r[t] + s.thickness, a = r.length,
                        l = t;
                    for (; l < a && r[l] < o; l += 1);
                    for (; l < a; l += 1) {
                        let e, t = i[l], n = ps(t, s.span.start, ds), r = n[0] + n[1], o = r;
    ...
    class Kl extends Gn {
        ...
        render() {
            ...
            return p(uo, {
                ...
                todayRange: e.todayRange,
                extraRenderProps: e.extraRenderProps
            }, t => p("div", { className: "fc-timegrid-col-frame" }, p("div", { className: "fc-timegrid-col-bg" }, this.renderFillSegs(e.businessHourSegs, "non-business"), this.renderFillSegs(e.bgEventSegs, "bg-event"), this.renderFillSegs(e.dateSelectionSegs, "highlight")), p("div", { className: "fc-timegrid-col-events" }, this.renderFgSegs(o, s, !1, !1, !1)), p("div", { className: "fc-timegrid-col-events" }, this.renderFgSegs(i, {}, Boolean(e.eventDrag), Boolean(e.eventResize), Boolean(r), "mirror")), p("div", { className: "fc-timegrid-now-indicator-container" }, this.renderNowIndicator(e.nowIndicatorSegs)), ho(n) && p(t, {
                elTag: "div",
        ...
        renderPositionedFgSegs(e, t, n, r, i, s) {
            let {
                ...
                todayRange: f,
                nowDate: g
            } = this.props, m = n || r || i, v = Xl(e, d, u, c), {
                segPlacements: b,
                hiddenGroups: E
            } = function (e, t, n, r) {
                let i = [], s = [];
                ...
                let { segRects: o, hiddenGroups: a } = Gl(i, n, r), l = [];
            ...
            return p(y, null, this.renderHiddenGroups(E, e), b.map(e => {
                let { seg: o, rect: l } = e, c = o.eventRange.instance.instanceId, d = m || Boolean(!t[c] && l),
                    u = tc(l && l.span), v = !m && l ? this.computeSegHStyle(l) : { left: 0, right: 0 },
        ...
        renderHiddenGroups(e, t) {
            ...
            return p(y, null, e.map(e => {
                let c = tc(e.span), d = (u = e.entries, h = t, u.map(e => h[e.index]));
                var u, h;
                return p(Fl, {
                    key: Ut(wo(d)),
                    hiddenSegs: d,
        ...
        renderFillSegs(e, t) {
            let { props: n, context: r } = this, i = Xl(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r, i) => {
                let s = e[i];
                return p("div", {
                    key: yi(s.eventRange),
                    className: "fc-timegrid-bg-harness",
                    style: tc(r)
                }, "bg-event" === t ? p(go, Object.assign({ seg: s }, mi(s, n.todayRange, n.nowDate))) : mo(t))
            });
            return p(y, null, i)
        }
    ...
    function ec(e, { todayRange: t, nowDate: n, eventSelection: r, eventDrag: i, eventResize: s }) {
        ...
        return p(y, null, e.map(e => {
            ...
            return p("div", { key: i, style: { visibility: o[i] ? "hidden" : "" } }, p(Jl, Object.assign({
                seg: e,
                isDragging: !1,
                isResizing: !1,
                isDateSelecting: !1,
    ...
    class nc extends Gn {
        constructor() {
            super(...arguments), this.splitFgEventSegs = Gt(Wl), this.splitBgEventSegs = Gt(Wl), this.splitBusinessHourSegs = Gt(Wl), this.splitNowIndicatorSegs = Gt(Wl), this.splitDateSelectionSegs = Gt(Wl), this.splitEventDrag = Gt(Ll), this.splitEventResize = Gt(Ll), this.rootElRef = { current: null }, this.cellElRefs = new Vs
        }
        ...
        render() {
            ...
            }, p("div", { className: "fc-timegrid-col-frame" }, p("div", { className: "fc-timegrid-now-indicator-container" }, "number" == typeof n && p(lo, {
                elClasses: ["fc-timegrid-now-indicator-arrow"],
                elStyle: { top: n },
                isAxis: !0,
                date: e.nowDate
    ...
    class rc extends ls {
        constructor() {
            super(...arguments), this.processSlotOptions = Gt(ic), this.state = { slatCoords: null }, this.handleRootEl = e => {
        ...
        queryHit(e, t) {
            ...
            if (null != c && null != d) {
                let e = this.props.cells[c], r = o.positions.tops[d], u = o.positions.getHeight(d), h = (t - r) / u,
                    f = d * l + Math.floor(h * l), g = this.props.cells[c].date, p = pt(s.slotMinTime, mt(a, f)),
    ...
    class oc extends ls {
        ...
        render() {
            ...
            return p(Rs, { unit: i ? "minute" : "day" }, (a, l) => p(rc, Object.assign({ ref: this.timeColsRef }, this.slicer.sliceProps(e, n, null, t, o), {
                forPrint: e.forPrint,
                axis: e.axis,
                dateProfile: n,
                slatMetas: e.slatMetas,
    ...
    function cc(e, t, n, r, i) {
        let s = new Date(0), o = e, a = ft(0), l = n || function (e) {
            let t, n, r;
            for (t = lc.length - 1; t >= 0; t -= 1) if (n = ft(lc[t]), r = bt(n, e), null !== r && r > 1) return n;
            return e
        }(r), c = [];
        for (; yt(o) < yt(t);) {
            let e = i.add(s, o), t = null !== bt(a, l);
            c.push({
                date: e,
                time: o,
                key: e.toISOString(),
                ...
                component: class extends Hl {
                    ...
                    render() {
                        let {
                            ...
                            c = !l, d = l, u = e.dayHeaders && p(_s, {
                                dates: s.headerDates,
                                dateProfile: i,
                                datesRepDistinctDays: !0,
                                renderIntro: c ? this.renderHeadAxis : null
                            }), h = !1 !== e.allDaySlot && (t => p(wl, Object.assign({}, o.allDay, {
                                dateProfile: i,
                                dayTableModel: s,
                                nextDayThreshold: e.nextDayThreshold,
                                tableMinWidth: t.tableMinWidth,
                                ...
                                clientHeight: t.clientHeight,
                                forPrint: r.forPrint
                            }, this.getAllDayMaxEventProps()))), f = t => p(oc, Object.assign({}, o.timed, {
                                dayTableModel: s,
                                dateProfile: i,
                                axis: c,
                                slotDuration: e.slotDuration,
    ...
    class hc extends Gn {
        ...
        render() {
            let { theme: e, dateEnv: t, options: n, viewApi: r } = this.context, {
                ...
                dayDate: s,
                todayRange: o
            } = this.props, { textId: a } = this.state, l = Fi(s, o),
        ...
        render() {
            ...
            return p(so, Object.assign({}, e, {
                ...
                if (!1 !== s.displayEventTime) {
                    ...
                    if (a.allDay ? c = !0 : ur(e.eventRange.range) ? e.isStart ? o = pi(e, t, n, null, null, l.range.start, e.end) : e.isEnd ? o = pi(e, t, n, null, null, e.start, l.range.end) : c = !0 : o = pi(e, t, n), c) {
    ...
    function yc(e) {
        let t = Mt(e.renderRange.start), n = e.renderRange.end, r = [], i = [];
        ...
        views: {
            list: {
                component: class extends ls {
                    constructor() {
                        super(...arguments), this.computeDateVars = Gt(yc), this.eventStoreToSegs = Gt(this._eventStoreToSegs), this.state = {
                            timeHeaderId: We(),
                            eventHeaderId: We(),
                            dateHeaderIdRoot: We()
                        }, this.setRootEl = e => {
                        ...
                        return p(Rs, { unit: "day" }, (e, l) => {
                            ...
                            for (let n = 0; n < a.length; n += 1) {
                                ...
                                if (d) {
                                    ...
                                    for (let t of d) c.push(p(pc, Object.assign({
                    ...
                    eventRangeToSegs(e, t) {
                        ...
                        for (n = 0; n < t.length; n += 1) if (r = ir(a, t[n]), r && (i = {
                            component: this,
                            eventRange: e,
                            start: r.start,
                            end: r.end,
    ...
    class Sc extends ls {
        constructor() {
            super(...arguments), this.buildDayTableModel = Gt(_l), this.slicer = new Dl, this.state = { labelId: We() }
        }
        ...
        render() {
            ...
            return p("div", {
                ...
                style: { height: i ? "" : l },
                role: "presentation"
            }, p("tbody", { role: "rowgroup" }, p(El, Object.assign({}, a, {
                dateProfile: r,
                cells: o.cells,
                eventSelection: e.eventSelection,
                dayMaxEvents: !i,
    ...
    function Dc(e, t, n, r, i) {
        ...
        for (; a.valueOf() < o.valueOf();) {
            const s = n.add(a, Ac), o = { start: e.skipHiddenDays(a), end: e.skipHiddenDays(s, -1, !0) };
            let c = Rl({ currentRange: o, snapToWeek: !0, fixedWeekCount: r, dateEnv: n });
    ...
    const wc = an({ year: "numeric", month: "long" }), Cc = an({ month: "long" });
    ...
    var _c = Po({
        name: "@fullcalendar/multimonth", initialView: "multiMonthYear", optionRefiners: xc, views: {
            multiMonth: {
                component: class extends ls {
                    constructor() {
                        super(...arguments), this.splitDateProfileByMonth = Gt(Dc), this.buildMonthFormat = Gt(Rc), this.scrollElRef = { current: null }, this.firstMonthElRef = { current: null }, this.needsScrollReset = !1, this.handleSizing = e => {
                            e && this.updateSize()
                        }
                    }
                    ...
                    render() {
                        ...
                        return p(er, { elRef: this.scrollElRef, elClasses: f, viewSpec: e.viewSpec }, u.map((e, n) => {
                ...
                }, dateProfileGeneratorClass: Cl, multiMonthMinWidth: 350, multiMonthMaxColumns: 3
            }, multiMonthYear: { type: "multiMonth", duration: { years: 1 }, fixedWeekCount: !0, showNonCurrentDates: !1 }
        }
    });
    return ca.push(el, Tl, uc, Ec, _c), e.Calendar = class extends Ni {
        constructor(e, t = {}) {
                ...
                if (this.isRendering) {
                    ...
                    jn(() => {
                        U(p(ki, {
                            ...
                            theme: e.theme,
                            emitter: e.emitter
                        }, (t, n, r, i) => (this.setClassNames(t), this.setHeight(n), p($n.Provider, { value: this.customContentRenderId }, p(_a, Object.assign({
                            isHeightAuto: r,
                            forPrint: i
                        }, e))))), this.el)
                    })
            ...
            }(e), this.el = e, this.renderRunner = new Me(this.handleRenderRequest), new ha({
                optionOverrides: t,
                calendarApi: this,
    ...
    }, e.Internal = xo, e.JsonRequestError = Ri, e.Preact = _o, e.ThirdPartyDraggable = class {
        constructor(e, t) {
            let n = document;
        ...
        let n = Ma(t), r = an(t), i = n.createMarkerMeta(e);
        return i ? n.format(i.marker, r, { forcedTzo: i.forcedTzo }) : ""
    }, e.formatRange = function (e, t, n) {
        let r = Ma("object" == typeof n && n ? n : {}), i = an(n), s = r.createMarkerMeta(e), o = r.createMarkerMeta(t);
    ...
    }, e.version = "6.1.9", Object.defineProperty(e, "__esModule", { value: !0 }), e
}({});