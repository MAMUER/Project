...
public class StaffScheduleService {
    ...
    private String formatDateTime(LocalDate date, Integer shift, boolean isStart) {
        ...
        switch (shift) {
            case 1:
                return isStart ? dateStr + "T06:00:00" : dateStr + "T12:00:00";
            case 2:
                return isStart ? dateStr + "T12:00:00" : dateStr + "T18:00:00";
            case 3:
                return isStart ? dateStr + "T18:00:00" : dateStr + "T23:59:00";
            default:
                return isStart ? dateStr + "T00:00:00" : dateStr + "T23:59:00";
        }
    }
